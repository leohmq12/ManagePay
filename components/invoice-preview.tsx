  ...
  return (
    <Card className="w-full max-w-4xl mx-auto bg-white">
      <CardContent className="p-8">
            ...
            <tbody>
              {items.map((item) => (
                <tr key={item.id} className="border-b border-gray-100">
                  ...
                  <td className="py-3 px-4 text-right">{formatCurrency(item.rate, currency)}</td>
                  <td className="py-3 px-4 text-right">{formatCurrency(item.amount, currency)}</td>
                </tr>
              ))}
            </tbody>
          </table>
        ...
        {/* Footer */}
        <div className="mt-12 pt-6 border-t border-gray-200 text-center text-xs text-muted-foreground">
